...
<html lang="ko">
   ...
   <form action = "combox_control.php" method = "POST">
         <select id = "s1" name = "hundred" onchange='superChange(this)'>
            <?php
         ...
         <select id = "s2" name = "ten" onchange='baseChange(this)'>
            <?php
        ...
        <script>
            function superChange(e){
               var josnArray = <?php echo json_encode($SecondArray) ?>;
               var target = document.getElementById("s2");
               target.innerHTML = "";
               for(var i = 0; i < josnArray[e.value].length; i++){
                  var opt = document.createElement('option');
                  opt.value = josnArray[e.value][i];
                  opt.innerHTML = josnArray[e.value][i];
                  target.appendChild(opt);
               }
               var josnArray = <?php echo json_encode($ThirdArray) ?>;
