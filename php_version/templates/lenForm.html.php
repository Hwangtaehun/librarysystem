        ...
        <fieldset id = form_fieldset>
            ...
            <div class="form_text">
                <ul>
                    ...
                    <?php } ?>
                    <li><label for ="im_check">회원아이디</label><br>
                    ...
                    <?php } ?>
                    <li><label for  ="mat_check">책이름</label><br>
                    ...
                    <li><label for  ="id_memo">메모</label><br>
