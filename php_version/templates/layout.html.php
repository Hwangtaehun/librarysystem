...
<html lang = "en">
    ...
    if(isset($_GET['pop'])){
        ...
        if($state == 1){
            ...
            $menus['상호대차'][1][0] = '상호대차승인거절';
            $menus['상호대차'][1][1] = '/del/aprelist';
            $menus['상호대차'][2][0] = '상호대차도착일추가';
            $menus['상호대차'][2][1] = '/del/addlist';
            $menus['상호대차'][3][0] = '상호대차완료내역';
            $menus['상호대차'][3][1] = '/del/completelist';
            $menus['기타'][0][0] = '회원관리';
